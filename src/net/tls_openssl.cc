...
public:
    ...
    // Registers `name` as the identity the peer certificate must carry. OpenSSL
    // then reports a mismatch through SSL_get_verify_result, so verify() sees
    // it like any other chain error.
